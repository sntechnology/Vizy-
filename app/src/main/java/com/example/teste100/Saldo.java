...
public class Saldo extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    public void onInit(int status) {
        if (status == TextToSpeech.SUCCESS) {
            ...
            if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
                ...
                // Frase automática
                String automaticPhrase = "Você tem 1200 reais";
    ...
    private void startVoiceRecognition() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Você tem 1200 reais");
